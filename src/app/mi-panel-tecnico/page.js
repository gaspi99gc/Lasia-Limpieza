...
function PanelContent() {
    ...
    const tab = rawTab === 'incidencias' ? 'incidencias' : rawTab === 'mantenimiento' ? 'mantenimiento' : 'pedidos';

    const heading = tab === 'incidencias' ? 'Incidencias' : tab === 'mantenimiento' ? 'Tickets de mantenimiento' : 'Pedidos';
