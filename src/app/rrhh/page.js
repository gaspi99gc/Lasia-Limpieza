...
export default async function RRHHPage({ searchParams }) {
    ...
    const initialTab = tab === 'personal' ? 'personal' : tab === 'periodos' ? 'periodos' : tab === 'licencias' ? 'licencias' : tab === 'informes' ? 'informes' : tab === 'recibos' ? 'recibos' : tab === 'legales' ? 'legales' : 'calendario';
