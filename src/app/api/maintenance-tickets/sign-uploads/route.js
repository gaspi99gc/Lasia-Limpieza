...
// Calcado del flujo de machine-incidents/sign-uploads pero apuntando al bucket nuevo.
export async function POST(req) {
    try {
        ...
        console.error('Error generando signed upload URLs (maintenance-tickets):', error);
