...
export default function WeWorkCapacitacionesPage() {
    ...
    return (
        <MainLayout>
            <div className="wework-page">
                <h1 style={{ fontSize: '1.4rem', fontWeight: 700, margin: '0 0 0.4rem' }}>Capacitaciones</h1>
                <p style={{ fontSize: '0.95rem', color: 'var(--text-muted)', margin: '0 0 1.5rem' }}>
                    Próximamente vas a poder ver las capacitaciones del personal.
                </p>
